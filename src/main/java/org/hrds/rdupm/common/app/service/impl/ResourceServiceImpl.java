    ...
    public List<ResourceVO> listResourceByIds(List<Long> projectIds) {
        ...
        projectIds.forEach(projectId -> {
            ...
            if (harborQuotaVo != null) {
                resourceVO.setCurrentHarborCapacity(df.format(Math.pow(harborQuotaVo.getUsedStorage(), 1.0 / 3.0)));
            }
            ...
            if (!CollectionUtils.isEmpty(nexusAssets)) {
                ...
                resourceVO.setCurrentNexusCapacity(df.format(Math.pow(count, 1.0 / 3.0)));
            }
