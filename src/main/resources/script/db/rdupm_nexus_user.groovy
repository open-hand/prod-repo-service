...
databaseChangeLog(logicalFilePath: 'script/db/rdupm_nexus_user.groovy') {
    changeSet(author: "weisen.yang@hand-china.com", id: "2020-05-28-rdupm_nexus_user") {
        ...
        createTable(tableName: "rdupm_nexus_user", remarks: "制品库_nexus仓库默认用户信息表") {
            ...
            column(name: "ne_user_id", type: "varchar(" + 100 * weight + ")",  remarks: "仓库默认发布用户Id")
            column(name: "ne_user_password", type: "varchar(" + 128 * weight + ")",  remarks: "仓库默认发布用户密码")
            column(name: "ne_pull_user_id", type: "varchar(" + 100 * weight + ")",  remarks: "仓库默认拉取用户Id")
            column(name: "ne_pull_user_password", type: "varchar(" + 128 * weight + ")",  remarks: "仓库默认拉取用户密码")
