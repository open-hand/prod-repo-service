...
databaseChangeLog(logicalFilePath: 'script/db/rdupm_nexus_push.groovy') {
    changeSet(author: "weisen.yang@hand-china.com", id: "2020-05-18-rdupm_nexus_push") {
        def weight = 1
        ...
        createTable(tableName: "rdupm_nexus_push", remarks: "制品库_nexus发布权限校验信息表") {
            column(name: "nexus_push_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
