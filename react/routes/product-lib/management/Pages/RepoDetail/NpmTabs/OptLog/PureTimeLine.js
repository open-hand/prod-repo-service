...
const TimeLine = ({ isMore, operateTypeLookupData, loadData, npmOptLogDs }) => {
  const record = npmOptLogDs.current && npmOptLogDs.toData();
  ...
  function loadMoreOptsRecord() {
    loadData(npmOptLogDs.currentPage + 1);
  }
