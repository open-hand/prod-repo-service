...
const NpmEditModal = ({
    ...
    modal.handleOk(async () => {
      ...
      if (validate) {
        ...
        try {
          ...
          await axios.put(`/rdupm/v1/nexus-repositorys/${organizationId}/project/${projectId}/npm/repo/${submitData.repositoryId}`, submitData);
          repoListDs.query();
          return true;
        } catch (error) {
          // message.error(error);
  ...
  }, [npmCreateDs, modal, createdRepoList]);
...
export default observer(NpmEditModal);
